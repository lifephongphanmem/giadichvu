...
class CreatePagdvvtxtxTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pagdvvtxtx', function (Blueprint $table) {
            $table->increments('id');
            ...
            //nglieu = nhienlieuchinh + nhienlieuboitron
            $table->double('cpcongnhantt')->default(0);
            //cpcongnhantt = luonglaixe
