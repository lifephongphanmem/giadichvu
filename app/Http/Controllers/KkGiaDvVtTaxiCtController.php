...
class KkGiaDvVtTaxiCtController extends Controller
{
    //Ajax Form edit
    public function storedv(Request $request){
        ...
        if($inputs['tendichvu']!=''){
            ...
            $modelkkgia->masokk = $inputs['masokk'];
            ...
            $model = KkDvVtXtxCt::where('masokk',$inputs['masokk'])
                ->get();
    ...
    public function editdv(Request $request){
        ...
        if(isset($inputs['id'])){
            ...
            $model = KkDvVtXtxCt::findOrFail($id);
            //dd($model);
    ...
    public function updatedv(Request $request){
        ...
        if($inputs['tendichvu']!='' && $inputs['id'] != ''){
            $modelkkgia = KkDvVtXtxCt::where('id',$inputs['id'])->first();
            $modelkkgia->tendichvu = $inputs['tendichvu'];
            $modelkkgia->qccl = $inputs['qccl'];
            $modelkkgia->dvt = $inputs['dvt'];
            $modelkkgia->ghichu = $inputs['ghichu'];
    ...
    public function kkgiadv(Request $request){
        ...
        if(isset($inputs['id'])){
            ...
            $model = KkDvVtXtxCt::where('id',$inputs['id'])
                ->first();
