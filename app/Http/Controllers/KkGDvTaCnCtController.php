...
class KkGDvTaCnCtController extends Controller
{
    public function storetthh(Request $request){
        ...
        if(isset($inputs['tenhh'])){
            $modelkkgia = new KkGDvTaCnCt();
            $modelkkgia->create($inputs);

            $model = KkGDvTaCnCt::where('mahs',$inputs['mahs'])
                ->get();
    ...
    public function editthh(Request $request){
        ...
        if(isset($inputs['id'])){
            ...
            $model = KkGDvTaCnCt::findOrFail($id);
            //dd($model);
    ...
    public function updatehh(Request $request){
        ...
        if(isset($inputs['id'])){
            $id= $inputs['id'];
            $modelkkgia = KkGDvTaCnCt::findOrFail($id);
    ...
    public function deletehh(Request $request){
        ...
        if(isset($inputs['id'])){
            $id= $inputs['id'];
            $modelkkgia = KkGDvTaCnCt::findOrFail($id)->delete();
    ...
    public function kkgiahh(Request $request){
        ...
        if(isset($inputs['id'])){
            ...
            $model = KkGDvTaCnCt::where('id',$inputs['id'])
                ->first();
