...
class KkGDvGsCtController extends Controller
{
    public function storetthh(Request $request){
        ...
        if(isset($inputs['tenhh'])){
            $modelkkgia = new KkGDvGsCt();
            $modelkkgia->create($inputs);

            $model = KkGDvGsCt::where('mahs',$inputs['mahs'])
                ->get();
    ...
    public function updatehh(Request $request){
        ...
        if(isset($inputs['id'])){
            $id= $inputs['id'];
            $modelkkgia = KkGDvGsCt::findOrFail($id);
    ...
    public function deletehh(Request $request){
        ...
        if(isset($inputs['id'])){
            $id= $inputs['id'];
            $modelkkgia = KkGDvGsCt::findOrFail($id)->delete();
    ...
    public function kkgiahh(Request $request){
        ...
        if(isset($inputs['id'])){
            ...
            $model = KkGDvGsCt::where('id',$inputs['id'])
                ->first();
