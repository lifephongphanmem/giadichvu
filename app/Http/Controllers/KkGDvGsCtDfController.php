...
class KkGDvGsCtDfController extends Controller
{
    public function storetthh(Request $request){
        ...
        if(isset($inputs['tenhh'])){
            $modelkkgia = new KkGDvGsCtDf();
            $modelkkgia->create($inputs);

            $model = KkGDvGsCtDf::where('masothue',$inputs['masothue'])
                ->get();
            ...
            $result['message'] .= '<th style="text-align: center">Tên hàng hoá, dịch vụ</th>';
            ...
            if(count($model) > 0){
                foreach($model as $key=>$tthh){
                    ...
                    $result['message'] .= '<td class="active">'.$tthh->tenhh.'</td>';
    ...
    public function editthh(Request $request){
        ...
        if(isset($inputs['id'])){
            ...
            $model = KkGDvGsCtDf::findOrFail($id);
            //dd($model);
    ...
    public function updatehh(Request $request){
        ...
        if(isset($inputs['id'])){
            $id= $inputs['id'];
            $modelkkgia = KkGDvGsCtDf::findOrFail($id);
    ...
    public function deletehh(Request $request){
        ...
        if(isset($inputs['id'])){
            $id= $inputs['id'];
            $modelkkgia = KkGDvGsCtDf::findOrFail($id)->delete();
    ...
    public function kkgiahh(Request $request){
        ...
        if(isset($inputs['id'])){
            ...
            $model = KkGDvGsCtDf::where('id',$inputs['id'])
                ->first();
