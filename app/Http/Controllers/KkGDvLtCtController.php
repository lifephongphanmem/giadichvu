...
{
    public function boxungttp(Request $request){
        $result = array(
            'status' => 'fail',
            'message' => 'error',
        );
    ...
    public function kkgiachinhsua(Request $request){
        $result = array(
            'status' => 'fail',
            'message' => 'error',
        );
    ...
    public function capnhatkkgia(Request $request){
        $result = array(
            'status' => 'fail',
            'message' => 'error',
        );
    ...
    public function chinhsuattp(Request $request){
        $result = array(
            'status' => 'fail',
            'message' => 'error',
        );
    ...
    public function capnhatttp(Request $request){
        $result = array(
            'status' => 'fail',
            'message' => 'error',
        );
        ...
        if(isset($inputs['id'])){
            $id = $inputs['id'];
            $modelttp = KkGDvLtCt::findOrFail($id);
    ...
    public function xoattp(Request $request){
        $result = array(
            'status' => 'fail',
            'message' => 'error',
        );
        ...
        if(isset($inputs['id'])){
            $id = $inputs['id'];
            $modelkkgia = KkGDvLtCt::findOrFail($id);
            $mahs = $modelkkgia->mahs;
            $modelkkgia->delete();

            $model = KkGDvLtCt::where('mahs',$mahs)
                ->get();
