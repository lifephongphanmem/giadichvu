...
<div class="page-header">
    ...
    <div class="page-header-top">
        <div class="container">
            <!-- BEGIN LOGO -->
            <div class="page-logo">
                <h3 style="text-transform: uppercase;"><b style="color: #25aae2">CÔNG BỐ GIÁ DỊCH VỤ</b>&nbsp;<b style="color: #454545">{{isset(getGeneralConfigs()['diadanh']) ? getGeneralConfigs()['diadanh'] : ''}}</b></h3>
            </div>
            <!-- END LOGO -->
            ...
            <div class="top-menu">
                ...
                @else
                    <a class="text-bold text-white no-underline" href="{{url('login')}}" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Truy cập vào hệ thống</a>
                    or <a class="text-bold text-white no-underline" href="{{url('search_register')}}" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Kiểm tra tài khoản đăng ký</a>
                @endif
            </div>
        ...
        <div class="container">
            ...
            <div class="hor-menu ">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="{{url('giadichvu')}}">Trang chủ</a>
                    </li>
