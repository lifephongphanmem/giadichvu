...
@section('content')
    ...
    <h3 class="page-title">
        Thông tin doanh nghiệp cung cấp <small>mặt hàng sữa</small>
    </h3>
    <!-- END PAGE HEADER-->
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        @if(can('dvgs','edit'))
                            @if(!isset($modeltttd))
                            <a href="{{url('ttdn_dich_vu_gia_sua/'.$model->id.'/edit')}}" class="btn btn-default btn-sm">
                                <i class="fa fa-edit"></i> Thay đổi thông tin </a>
                            @elseif($modeltttd->trangthai != 'Chờ duyệt')
                                <a href="{{url('ttdn_dich_vu_gia_sua/'.$modeltttd->id.'/chinhsua')}}" class="btn btn-default btn-sm">
                                    <i class="fa fa-edit"></i> Chỉnh sửa thông tin </a>
                                <a href="{{url('ttdn_dich_vu_gia_sua/'.$modeltttd->id.'/chuyen')}}" class="btn btn-default btn-sm">
