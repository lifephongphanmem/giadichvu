...
@section('content')
    <h3 class="page-title">
        Thông tin doanh nghiệp cung cấp mặt hàng sữa<small> chỉnh sửa</small>
    </h3>
    <!-- END PAGE HEADER-->
        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::model($model, ['method' => 'PATCH', 'url'=>'ttdn_dich_vu_gia_sua/df/'. $model->id, 'class'=>'horizontal-form','id'=>'update_tttaikhoan']) !!}
            ...
            <div class="row" style="text-align: center">
                <div class="col-md-12">
                    <a href="{{url('ttdn_dich_vu_gia_sua')}}" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp;Quay lại</a>
