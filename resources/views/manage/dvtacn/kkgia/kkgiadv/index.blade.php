    ...
    <script>
        ...
        $(function(){
            ...
            $('#namhs').change(function() {
                ...
                var url = '/ke_khai_thuc_an_chan_nuoi?&masothue='+masothue+'&nam='+nam;
...
@section('content')
                    ...
                    <div class="actions">
                        @if(can('kkdvtacn','create'))
                            <!--a href="{{url('ke_khai_dich_vu_luu_tru/co_so_kinh_doanh=/copy')}}" class="btn btn-default btn-sm">
                                ...
                                <a href="{{url('ke_khai_thuc_an_chan_nuoi/masothue='.$modeldn->masothue.'/create')}}" class="btn btn-default btn-sm">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="sample_3">
                        ...
                        @foreach($model as $key=>$tt)
                            <tr>
                                ...
                                @endif
                                <td>
                                    <a href="{{url('ke_khai_thuc_an_chan_nuoi/report_ke_khai/'.$tt->mahs)}}" target="_blank" class="btn btn-default btn-xs mbs"><i class="fa fa-eye"></i>&nbsp;Xem chi tiết</a>

                                    @if($tt->trangthai == 'Chờ chuyển' || $tt->trangthai == 'Bị trả lại')
                                        @if(can('kkdvtacn','edit'))
                                            <a href="{{url('ke_khai_thuc_an_chan_nuoi/'.$tt->id.'/edit')}}" class="btn btn-default btn-xs mbs"><i class="fa fa-edit"></i>&nbsp;Chỉnh sửa</a>
                                        @endif
                                        ...
                                        @endif
                                    @endif
                                    <!--a href="{{url('ke_khai_thuc_an_chan_nuoi/'.$tt->mahs.'/history')}}" target="_blank" class="btn btn-default btn-xs mbs"><i class="fa fa-eye"></i>&nbsp;Lịch sử</a-->
        ...
        <div class="modal fade" id="chuyen-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    {!! Form::open(['url'=>'ke_khai_thuc_an_chan_nuoi/chuyen','id' => 'frm_chuyen'])!!}
    ...
    <!--Model chuyển hs chậm-->
        <div class="modal fade" id="chuyenhscham-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    {!! Form::open(['url'=>'ke_khai_thuc_an_chan_nuoi/chuyenhscham','id' => 'frm_chuyenhscham'])!!}
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
    ...
    <!--Model copy-->
        <div class="modal fade" id="copy-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    {!! Form::open(['url'=>'ke_khai_thuc_an_chan_nuoi/copy','id' => 'frm_chuyen'])!!}
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
    ...
    <div class="modal fade" id="delete-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                {!! Form::open(['url'=>'ke_khai_thuc_an_chan_nuoi/delete','id' => 'frm_delete'])!!}
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
