...
@section('content')
    ...
    <h3 class="page-title">
        Thông tin kê khai giá thức ăn chăn nuôi<small>&nbsp;chỉnh sửa</small>
    </h3>

    <!-- END PAGE HEADER-->
    <div class="row">
        {!! Form::model($model, ['method' => 'PATCH', 'url'=>'ke_khai_thuc_an_chan_nuoi/'. $model->id, 'class'=>'horizontal-form','id'=>'update_kkdvgs']) !!}
        <div class="col-md-12">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="sample_3">
                                ...
                                @foreach($modelct as $key=>$tt)
                                    <tr>
                                        ...
                                        <td class="active">{{$tt->mahh}} - {{$tt->tenhh}}</td>
                                        <td>{{$tt->qccl}}</td>
                                        <td>{{$tt->dvt}}</td>
            ...
            <div style="text-align: center">
                <a href="{{url('ke_khai_thuc_an_chan_nuoi?&masothue='.$model->masothue)}}" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp;Quay lại</a>
