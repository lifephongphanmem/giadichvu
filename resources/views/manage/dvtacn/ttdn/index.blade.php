            ...
            <div class="portlet box">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        @if(can('dvtacn','edit'))
                            @if(!isset($modeltttd))
                            <a href="{{url('ttdn_thuc_an_chan_nuoi/'.$model->id.'/edit')}}" class="btn btn-default btn-sm">
                                <i class="fa fa-edit"></i> Thay đổi thông tin </a>
                            @elseif($modeltttd->trangthai != 'Chờ duyệt')
                                <a href="{{url('ttdn_thuc_an_chan_nuoi/'.$modeltttd->id.'/chinhsua')}}" class="btn btn-default btn-sm">
                                    <i class="fa fa-edit"></i> Chỉnh sửa thông tin </a>
                                <a href="{{url('ttdn_thuc_an_chan_nuoi/'.$modeltttd->id.'/chuyen')}}" class="btn btn-default btn-sm">
