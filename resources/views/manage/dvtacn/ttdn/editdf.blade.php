...
@section('content')
    <h3 class="page-title">
        Thông tin doanh nghiệp thức ăn chăn nuôi<small> chỉnh sửa</small>
    </h3>
    <!-- END PAGE HEADER-->
        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::model($model, ['method' => 'PATCH', 'url'=>'ttdn_thuc_an_chan_nuoi/df/'. $model->id, 'class'=>'horizontal-form','id'=>'update_tttaikhoan']) !!}
            ...
            <div class="row" style="text-align: center">
                <div class="col-md-12">
                    <a href="{{url('ttdn_thuc_an_chan_nuoi')}}" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp;Quay lại</a>
