...
@section('content')
    <h3 class="page-title">
        Kê khai giá dịch vụ vận tải xe khách<small> chỉnh sửa</small>
    </h3>
    <div class="row">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" id="ttgiaph">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                        <label class="form-control-label"><b>Mức giá hàng hóa vượt quy định</b><span class="require">*</span></label>
