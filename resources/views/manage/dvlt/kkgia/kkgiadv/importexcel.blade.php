...
@section('content')
    ...
    <h3 class="page-title">Nhận dữ liệu kê khai giá dịch vụ lưu trú từ file Excel<small> đối với cơ sở kinh doanh không có yếu tố nước ngoài </small> </h3>
    <!-- END PAGE HEADER-->
        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                <div class="portlet-body form">
                    <!-- BEGIN FORM -->
                    {!! Form::open(['url'=>'/kekhaidvlt/import_excel', 'method'=>'post' , 'files'=>true, 'id' => 'create_hscb','enctype'=>'multipart/form-data']) !!}
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label class="control-label">Tên cơ sở kinh doanh : {{$model->tencskd}}<span class="require">*</span></label>
                                                            {!!Form::hidden('macskd', $inputs['macskd'], array('id' => 'macskd','class' => 'form-control'))!!}
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            {!!Form::text('loaip', 'A', array('id' => 'loaip','class' => 'form-control required'))!!}
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label class="control-label">Quy cách chất lượng<span class="require">*</span></label>
                                                            {!!Form::text('qccl', 'B', array('id' => 'qccl','class' => 'form-control required'))!!}
                                                        </div>
                                                    </div>

                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label class="control-label">Số hiệu phòng<span class="require">*</span></label>
                                                            {!!Form::text('sohieu', 'C', array('id' => 'sohieu','class' => 'form-control required'))!!}
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            {!!Form::text('mucgialk', 'E', array('id' => 'mucgialk','class' => 'form-control required'))!!}
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
            ...
            <div class="col-md-12" style="text-align: center">
                <a href="{{url('ke_khai_dich_vu_luu_tru/co_so_kinh_doanh='.$inputs['macskd'].'&nam='.date('Y'))}}" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp;Quay lại</a>
    ...
    <script>
        function ClickCreate(){
            ...
            if (!$('#loaip').val()) {
                str += '  - Loại phòng \n';
                $('#loaip').parent().addClass('has-error');
                ok = false;
            }
            ...
            if (!$('#mucgialk').val()) {
                str += '  - Mức giá liền kề \n';
                $('#mucgialk').parent().addClass('has-error');
                ok = false;
            }

            if (!$('#mucgiakk').val()) {
                str += '  - Mức giá kê khai \n';
                $('#mucgiakk').parent().addClass('has-error');
                ok = false;
            }
