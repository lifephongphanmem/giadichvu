                ...
                <div class="portlet-body">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="sample_3">
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td>{{$tt->masothue}}</td>
                            <td class="success">{{$tt->tencskd}}</td>
                            <td>{{$tt->loaihang}}</td>
                            <td>{{$tt->diachikd}}</td>
                            <td>
                                <a href="{{url('hoatdongcskd?&macskd='.$tt->macskd)}}" class="btn btn-default btn-xs mbs"><i class="fa fa-edit"></i>&nbsp;Hoạt động Cơ sở kinh doanh</a>
                            </td>
                        </tr>
                        @endforeach
                        </tbody>
