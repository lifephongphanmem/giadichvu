...
@section('content-cb')
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <ul class="contact-info">
                        @if($modelcskd->link !='')
                            <li><i class="glyphicon glyphicon-cloud-upload"></i><a href="http://{{$modelcskd->link}}" target="_blank"> Trang chủ</a> </li>
                        @endif
                ...
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption caption-md">
                            ...
                            <span class="caption-subject theme-font bold uppercase">Thông tin hồ sơ kê khai dịch vụ lưu trú</span>
                        </div>
                        <div class="actions">
                        </div>
                    </div>
    ...
    <div style="text-align: center">
        <a href="{{url('giadichvuluutru/'.$modelcskd->macskd)}}" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp;Quay lại</a>
    </div>
    <div class="clearfix">
    </div>

    <div class="modal fade in" id="modal-show" tabindex="-1" role="dialog" aria-hidden="true">
