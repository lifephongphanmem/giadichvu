...
@section('content')
    ...
    <h3 class="page-title">
        Thông tin doanh nghiêp cung cấp <small>&nbsp;thức ăn chăn nuôi</small>
    </h3>
    <!-- END PAGE HEADER-->
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="portlet-body">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="sample_3">
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td>{{$tt->diachidn}}</td>
                            <td>
                                <a href="{{url('dn_thuc_an_chan_nuoi/'.$tt->id.'/edit')}}" class="btn btn-default btn-xs mbs"><i class="fa fa-edit"></i>&nbsp;Chỉnh sửa</a>
        ...
        <div class="modal fade" id="delete-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    {!! Form::open(['url'=>'dn_thuc_an_chan_nuoi/delete','id' => 'frm_delete'])!!}
