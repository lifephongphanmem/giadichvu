...
@section('content')
    ...
    <h3 class="page-title">
        Thông tin doanh nghiệp cung cấp thức ăn chăn nuôi<small> chỉnh sửa</small>
    </h3>
    <!-- END PAGE HEADER-->
        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::model($model, ['method' => 'PATCH', 'url'=>'dn_thuc_an_chan_nuoi/'. $model->id, 'class'=>'horizontal-form','id'=>'update_tttaikhoan']) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2me required" id="cqcq" name="cqcq">
                                            ...
                                            @foreach($modelql as $ttpb)
                                                <option value="{{$ttpb->maqhns}}" {{$ttpb->maqhns == $model->cqcq ? 'selected' : ''}}>{{$ttpb->tendv}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
            ...
            <div style="text-align: center">
                <a href="{{url('dn_thuc_an_chan_nuoi')}}" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp;Quay lại</a>
