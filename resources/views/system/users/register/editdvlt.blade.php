        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::model($model, ['method' => 'PATCH', 'url'=>'users/register/dvlt/'. $model->id, 'class'=>'horizontal-form','id'=>'update_register']) !!}
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="teldn" id="teldn" value="{{$model->teldn}}">
                                </div>
                            </div>
                            <!--/span-->
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="faxdn" id="faxdn" value="{{$model->faxdn}}">
                                </div>
                            </div>
                            <!--/span-->
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="diachidn" id="diachidn" value="{{$model->diachidn}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
