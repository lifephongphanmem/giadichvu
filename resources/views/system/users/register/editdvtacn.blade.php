...
@section('content')
    <h3 class="page-title">
        Chỉnh sửa thông tin doanh nghiệp cung cấp thức ăn chăn nuôi <small> đăng ký tài khoản</small>
    </h3>
    <!-- END PAGE HEADER-->
        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::model($model, ['method' => 'PATCH', 'url'=>'users/register/dvtacn/'. $model->id, 'class'=>'horizontal-form','id'=>'update_register']) !!}
    ...
    <div class="row" style="text-align: center">
        <div class="cod-md-12">
            <a href="{{url('users/register?&phanloai=DVTACN')}}" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp;Quay lại</a>
