...
@section('content')
    <h3 class="page-title">
        Chỉnh sửa thông tin doanh nghiệp cung cấp sữa <small> đăng ký tài khoản</small>
    </h3>
    <!-- END PAGE HEADER-->
        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::model($model, ['method' => 'PATCH', 'url'=>'users/register/dvgs/'. $model->id, 'class'=>'horizontal-form','id'=>'update_register']) !!}
