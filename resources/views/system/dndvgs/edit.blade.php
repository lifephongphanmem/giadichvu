...
@section('content')
    ...
    <h3 class="page-title">
        Thông tin doanh nghiệp cung cấp sản phẩm sữa<small> chỉnh sửa</small>
    </h3>
    <!-- END PAGE HEADER-->
        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::model($model, ['method' => 'PATCH', 'url'=>'dn_dichvu_giasua/'. $model->id, 'class'=>'horizontal-form','id'=>'update_tttaikhoan']) !!}
            ...
            <div style="text-align: center">
                <a href="{{url('dn_dichvu_giasua')}}" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp;Quay lại</a>
