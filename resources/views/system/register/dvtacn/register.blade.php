...
<div class="content">
    <!-- BEGIN REGISTER FORM -->
    {!! Form::open(['url'=>'/dangkydichvuthucanchannuoi','id' => 'form-register', 'class'=>'register-form"']) !!}
    <!--form class="register-form" action="index.html" method="post" novalidate="novalidate" style="display: block;"-->
    <div class="row">
    <div class="col-md-12">
        <p>Thông tin doanh nghiêp cung cấp thức ăn chăn nuôi</p>
        <div class="row">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <div class="input-icon">
                        <i class="fa fa-key"></i>
                        <input class="form-control required" type="text" placeholder="Mã số thuế" name="masothue" id="masothue">
                    </div>
                </div>
            </div>
            <!--/span-->
